    ...
    <div className="">
      ...
      <div className="mt-24 max-w-3xl mx-auto text-justify leading-8">
        <p>
          ...
          accusantium quaerat, maxime cupiditate praesentium beatae. Et sint
          distinctio sed? Beatae perspiciatis minima similique accusamus facilis
          quod eaque? Eligendi, magnam odio?
        </p>
        <p>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Blanditiis
          accusantium quaerat, maxime cupiditate praesentium beatae. Et sint
