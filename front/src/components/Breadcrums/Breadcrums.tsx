...
export default function Breadcrums({ className }: { className?: string }) {
  ...
  return (
    <div
      className={`flex gap-3 my-3 lg:my-6 mx-3 p-2 lg:p-3 xl:mx-auto items-center max-w-7xl  bg-gradient-to-br text-white to-blue-400 from-slate-200  dark:text-gray-200 dark:bg-slate-600/50 shadow-md rounded-md ${className}`}
    >
      {newArry.map((i, index) => (
