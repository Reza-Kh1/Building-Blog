  ...
  return props.map((i, index) => (
    ...
    >
      <div className="w-2/5 lg:w-1/3 order-1">
        <ImgTag alt={i.title} height={200} src={i.image} width={450} className="w-44 md:w-80 md:h-56 lg:w-[450px] lg:h-72 h-36 object-cover"/>
      </div>
      <div className="w-3/5 lg:w-2/3 order-2 flex justify-evenly md:justify-between flex-col md:py-2 gap-1">
        ...
        <p className="text-xs lg:text-sm text-gray-700 cutline text-justify">
          {i.description}</p>
