                ...
                <div className='border dark:border-bg-dark my-2 rounded-sm shadow-sm dark:shadow-full-dark pr-7 lg:pr-10 pl-2 lg:pl-3 py-2 lg:py-5'>
                    <div className='flex w-full justify-between mb-3'>
                        <div className='flex flex-col'>
                            <span className='text-sm lg:text-base text-gray-700 dark:text-h-dark'>{data?.name}</span>
                            <span className='text-[0.60rem] lg:text-xs text-gray-400 italic dark:text-s-dark'>{new Date(data?.createdAt).toLocaleDateString("fa")}</span>
                        </div>
